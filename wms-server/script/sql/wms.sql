...
INSERT INTO `sys_user` VALUES (1,100,'admin','admin','sys_user','zccbbg@qq.com','18888888888','0','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','1','0','172.18.0.1','2026-01-06 10:01:58','admin','2024-06-13 16:06:25','admin','2026-01-06 10:01:58','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=2008376032512671747 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='AGV开放接口任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2008368715662589954 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='AGV任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_material_type` (
  ...
  `update_time` datetime(3) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2008010842706194435 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='物料类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_material_type` VALUES (2008010842706194434,'VALVE','阀门',1,'0',NULL,'admin','2026-01-05 11:01:06.597','admin','2026-01-05 11:01:06.597');
...
CREATE TABLE `wms_valve` (
  ...
  KEY `idx_current_bin_id` (`current_bin_id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2008368688563191810 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='阀门表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_valve` VALUES (2008358597118099458,'a001',2008010842706194434,'a001','abc',NULL,1998574183371882656,'x006',2008093160030343170,'B1-6-01',0,'2026-01-06',NULL,NULL,NULL,'admin','2026-01-06 10:02:57.711','admin','2026-01-06 10:02:57.711'),(2008368688563191809,'j001',2008010842706194434,'j001','甲',NULL,1998574183371882651,'x001',2004486396047355906,'B1-1-01',0,'2026-01-06',NULL,NULL,NULL,'admin','2026-01-06 10:43:03.697','admin','2026-01-06 10:43:03.697');
...
-- Dump completed on 2026-01-06 13:20:44
