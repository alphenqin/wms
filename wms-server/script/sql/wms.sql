...
INSERT INTO `sys_user` VALUES (1,100,'admin','admin','sys_user','zccbbg@qq.com','18888888888','0','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','1','0','127.0.0.1','2026-01-12 18:38:47','admin','2024-06-13 16:06:25','admin','2026-01-12 18:38:47','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=2010651190276558850 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='AGV开放接口任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2010647809076137986 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='AGV任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_valve` (
  ...
  KEY `idx_current_bin_id` (`current_bin_id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2010647801559945219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='阀门表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_valve` VALUES (2008358597118099458,'a001','abc',NULL,1998574183371882656,'x006',2008093160030343170,'B1-6-01',0,'2026-01-06',NULL,NULL,NULL,'admin','2026-01-06 10:02:57.711','admin','2026-01-06 10:02:57.711'),(2008368688563191809,'j001','甲',NULL,1998574183371882651,'x001',2004486396047355906,'B1-1-01',0,'2026-01-06',NULL,NULL,NULL,'admin','2026-01-06 10:43:03.697','admin','2026-01-06 10:43:03.697'),(2008466638036447233,'q001','秦',NULL,1998574183371882651,'x001',2004486396047355906,'B1-1-01',0,'2026-01-06',NULL,NULL,'F3','admin','2026-01-06 17:12:16.672','admin','2026-01-07 13:28:15.692'),(2008781565990580226,'b001','张三',NULL,1998574183371882654,'x004',2008016205821173762,'B1-4-01',0,'2026-01-07',NULL,NULL,'F1-检测点','admin','2026-01-07 14:03:41.347','admin','2026-01-07 14:32:50.589'),(2010647801559945218,'a0','abc',NULL,1998574183371882651,'x001',2004486396047355906,'B1-1-01',0,'2025-03-07',NULL,NULL,NULL,'admin','2026-01-12 17:39:26.581','admin','2026-01-12 17:39:26.581');
...
-- Dump completed on 2026-01-12 18:44:30
