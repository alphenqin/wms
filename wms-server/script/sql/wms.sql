...
INSERT INTO `sys_user` VALUES (1,100,'admin','admin','sys_user','zccbbg@qq.com','18888888888','0','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','1','0','172.18.0.1','2026-01-05 14:22:15','admin','2024-06-13 16:06:25','admin','2026-01-05 14:22:15','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=2008059826131165186 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='AGV任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_bin` (
  ...
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2008016205821173763 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='货位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_valve` (
  ...
  KEY `idx_current_bin_id` (`current_bin_id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2008059803087659011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='阀门表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_valve` VALUES (2008011201419849729,'a001',2008010842706194434,'a001','Abc',NULL,1998574183371882651,'x001',2004486396047355906,'B1-1-01',0,'2026-01-05',NULL,NULL,NULL,'admin','2026-01-05 11:02:32.120','admin','2026-01-05 11:02:32.120'),(2008017956976648194,'a002',2008010842706194434,'a002','abc',NULL,1998574183371882652,'x002',2008015668421779457,'B1-2-01',0,'2026-01-05',NULL,NULL,NULL,'admin','2026-01-05 11:29:22.770','admin','2026-01-05 11:29:22.770'),(2008028633934249986,'a003',2008010842706194434,'a003','abc',NULL,1998574183371882653,'x003',2008015875326795778,'B1-3-01',0,'2026-01-05',NULL,NULL,NULL,'admin','2026-01-05 12:11:48.357','admin','2026-01-05 12:11:48.357'),(2008059803087659010,'a005',2008010842706194434,'a005','abc',NULL,1998574183371882654,'x004',2008016205821173762,'B1-4-01',0,'2026-01-05',NULL,NULL,NULL,'admin','2026-01-05 14:15:39.662','admin','2026-01-05 14:15:39.662');
...
-- Dump completed on 2026-01-05 14:34:29
